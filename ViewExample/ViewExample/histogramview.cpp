...
QRect HistogramView::visualRect(const QModelIndex &index)const{ QRect rect; return rect; }

void HistogramView::scrollTo(const QModelIndex &index, ScrollHint){ }

QModelIndex HistogramView::moveCursor(QAbstractItemView::CursorAction cursorAction, Qt::KeyboardModifiers modifiers){ QModelIndex modelindex; return modelindex; }

int HistogramView::horizontalOffset()const{ return true; }

int HistogramView::verticalOffset()const{ return true; }

bool HistogramView::isIndexHidden(const QModelIndex &index)const{ return true; }
