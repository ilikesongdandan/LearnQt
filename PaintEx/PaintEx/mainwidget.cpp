	...
	: QWidget(parent)
{
	...
	penJoinLabel = new QLabel(tr("pen join:"));     //画笔连接点风格选择下拉列表框
	...
	brushColorlabel = new QLabel(tr("brush color:"));   	//画刷颜色选择控件
	...
	brushStyleLabel = new QLabel(tr("brush style:"));   	//画刷风格选择下拉列表框
